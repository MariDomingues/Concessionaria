...
uses
  ...
  UnitManFuncionario in 'UnitManFuncionario.pas' {Frm_Man_Funcionario},
  ...
  UnitManCargo in 'UnitManCargo.pas' {Frm_Man_Cargo},
...
begin
  ...
  Application.CreateForm(TFrm_Man_Funcionario, Frm_Man_Funcionario);
  ...
  Application.CreateForm(TFrm_Man_Cargo, Frm_Man_Cargo);
